...
export function SettingsScreen() {
  ...
  return (
    <Screen>
      ...
      <Card><AccessibleText variant="bodyLarge" weight="800">Notifications</AccessibleText><Button label="Notification preferences" variant="quiet" onPress={() => navigation.navigate("NotificationSettings")} /></Card>
      <Card><AccessibleText variant="bodyLarge" weight="800">Safety & account</AccessibleText><Button label="Two-factor authentication" variant="quiet" onPress={() => navigation.navigate("TwoFactorSettings")} /><Button label="Safety center" variant="quiet" onPress={() => navigation.navigate("SafetyCenter")} /><Button label="Blocked users" variant="quiet" onPress={() => navigation.navigate("BlockedUsers")} /><Button label="Log out" variant="danger" onPress={() => void signOut()} /></Card>
    </Screen>
  );
}
